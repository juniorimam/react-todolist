  ...
  return (
    <div className="min-h-screen  bg-gray-100 dark:bg-neutral-800">
      <div className="lg:w-4/12 md:w-6/12 mx-auto flex flex-col justify-center text-center min-h-screen relative">
        ...
        <div className="flex flex-row gap-x-4 absolute bottom-5 left-1/2 -translate-x-1/2 ">
          <button
            onClick={toggleTheme}
            className="bg-gray-300 rounded-lg flex flex-row justify-center items-center gap-x-3 p-3 w-fit dark:bg-neutral-900 duration-300"
